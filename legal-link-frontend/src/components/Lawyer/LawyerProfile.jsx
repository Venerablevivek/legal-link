...
import { updateLawyer } from '../../services/authAPI';
  ...
  return (
    ...
    <form className='flex flex-col gap-10 ' onSubmit={handleSubmit} >
       ...
       <div className=' flex items-center gap-3 ' >
         {
           formData.imageUrl && <figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-red-500 flex items-center justify-center ' >
